    ...
    <div class="main">
        <div class="topbar">
            ...
            <div class="topbar-actions">
                <a href="<?= site_url('admin/employe/form') ?>" class="btn-forest"><i class="bi bi-person-plus"></i> Ajouter Employé</a>
            </div>
        </div>
        <div class="content">
            <div class="data-card">
                ...
                <table class="tbl">
                    <thead><tr><th>Employé</th><th>Email</th><th>Département</th><th>Rôle</th><th>Statut</th><th>Action</th></tr></thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-btns">
                                    <a class="btn-sm btn-edit" href="<?= site_url('admin/employe/edit/' . $employe['id']) ?>"><i class="bi bi-pencil"></i> Modifier</a>
                                </div>
                            </td>
                        </tr>
                    <?php endforeach; else : ?>
